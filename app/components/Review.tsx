export default function Review() {
  return (
    <div className="overflow-hidden bg-orange-950">
      <div className="relative max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl w-3/4 lg:w-1/2 mb-3 sm:mb-10 md:mb-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col bg-white rounded-xl">
              <div className="flex-auto p-4 md:p-6">
                <p className="text-base italic md:text-lg text-gray-800">
                  &quot;I was blown away by the exceptional service and quality
                  of work provided. I highly recommend to anyone looking for
              ...
              <div className="p-4 bg-gray-100 rounded-b-xl md:px-7">
                <div className="flex items-center">
                  ...
                  <div className="grow ms-3">
                    ...
                    <p className="text-xs text-gray-500">Dev &apos;Ops</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex h-auto">
            <div className="flex flex-col bg-white rounded-xl">
              <div className="flex-auto p-4 md:p-6">
                <p className="text-base italic md:text-lg text-gray-800">
                  &quot;Thanks to Assignment-Sorted, I have been able to connect
                  with my audience on a deeper level. I couldn&apos;t be happier
                  with the results&quot;
                </p>
              </div>
          ...
          <div className="flex h-auto">
            <div className="flex flex-col bg-white rounded-xl">
              <div className="flex-auto p-4 md:p-6">
                <p className="text-base italic md:text-lg text-gray-800">
                  &quot;Working with Assignment-Sorted has been a game-changer
                  for my business. I look forward to continuing our
        ...
        <div className="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
          <div>
            ...
            <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-orange-100">
              99.95%
            </p>
            <p className="mt-1 text-orange-400">in fulfilling orders</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-1 text-orange-400">this year alone</p>
          </div>
        </div>
